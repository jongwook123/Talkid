...
-- Schema s09p12d106
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `s09p12d106` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `s09p12d106` ;
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`bad_words` (
  `badwords_id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`school` (
  ...
  `time_zone_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`school_id`),
  INDEX `FKmmw63q4abgfsybnahm1q9we80` (`country_id` ASC) VISIBLE,
  INDEX `FKsu0573khpx70tpi2qbcl2t3gs` (`time_zone_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`member` (
  ...
  `member_filter_count` INT NULL DEFAULT NULL,
  ...
  INDEX `FKimgxpbvyco1xw2gw8nia3f9kv` (`country_id` ASC) VISIBLE,
  INDEX `FKpri7c3h75h17hga2383pa7m9f` (`language_id` ASC) VISIBLE,
  INDEX `FKhy7vopt86e2jdoovh4dw4us4i` (`member_type_id` ASC) VISIBLE,
  INDEX `FKsxpmhkgwynlgsa63v3xle1ct1` (`school_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`book_mark` (
  `book_mark_id` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `FKl0894dc2yqctftjaqgqyhpb34` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`dm_join_member` (
  `dm_join_member_id` INT NOT NULL AUTO_INCREMENT,
  `dm_room_id` VARCHAR(100) NULL DEFAULT NULL,
  `member_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`dm_join_member_id`),
  INDEX `FKra39ndqsndi8pqrvwljjpk19n` (`dm_room_id` ASC) VISIBLE,
  INDEX `FK767semgfmmg3gtg1521plkkdg` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`exp` (
  ...
  `exp_point` INT NULL DEFAULT NULL,
  `member_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`exp_id`),
  INDEX `FKhmpbd8s8xovphhc0u5v7lx5d3` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`group_join_member` (
  `group_join_member_id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `group_id` INT NULL DEFAULT NULL,
  `member_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`group_join_member_id`),
  INDEX `FKl363rfubt7ftomwxcl2rofyhq` (`group_id` ASC) VISIBLE,
  INDEX `FK70n0orw13vynl9i33o47cv28l` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`meeting` (
  ...
  `group_req` INT NULL DEFAULT NULL,
  `group_res` INT NULL DEFAULT NULL,
  PRIMARY KEY (`meeting_id`),
  INDEX `FKlswbhob9102kwtb2kymcmyrx1` (`group_req` ASC) VISIBLE,
  INDEX `FK825oeebbag02u8gsghjvhge8q` (`group_res` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`meeting_schedule` (
  ...
  INDEX `FKkhpjkvd05wwpfme4s59dwhos7` (`group_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`meeting_join_req` (
  `meeting_join_req_id` INT NOT NULL AUTO_INCREMENT,
  `group_id` INT NULL DEFAULT NULL,
  `meeting_schedule_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`meeting_join_req_id`),
  INDEX `FK986o5v7iuuhwvbi1q6igx1ag6` (`group_id` ASC) VISIBLE,
  INDEX `FK2ss81ulb5a7urbwrrvc9s4092` (`meeting_schedule_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`member_apply` (
  `member_apply_id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `group_id` INT NULL DEFAULT NULL,
  `member_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`member_apply_id`),
  INDEX `FKdb0nllx3p2dmuimhqxuurett` (`group_id` ASC) VISIBLE,
  INDEX `FK6n5p4t1gue8fxwgm531s7rew8` (`member_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`message` (
  ...
  INDEX `FKtc0hp7tse676xfow0ym0jegax` (`dm_room_id` ASC) VISIBLE,
  INDEX `FK4msccpwmxulmw875edu7p352d` (`member_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `s09p12d106`.`notify_content`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `s09p12d106`.`notify_content` ;

CREATE TABLE IF NOT EXISTS `s09p12d106`.`notify_content` (
  `notify_content_id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `notify_body` VARCHAR(100) NOT NULL,
  `notify_header` VARCHAR(45) NOT NULL,
  `member_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`notify_content_id`),
  INDEX `FK632twfqwsmij2laxqaawcryuu` (`member_id` ASC) VISIBLE,
  CONSTRAINT `FK632twfqwsmij2laxqaawcryuu`
    FOREIGN KEY (`member_id`)
    REFERENCES `s09p12d106`.`member` (`member_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 5
...
-- -----------------------------------------------------
-- Table `s09p12d106`.`notify_receiver`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `s09p12d106`.`notify_receiver` ;

CREATE TABLE IF NOT EXISTS `s09p12d106`.`notify_receiver` (
  `notify_receiver_id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `notify_receiver_checked` BIT(1) NOT NULL,
  `member_id` INT NULL DEFAULT NULL,
  `notify_content_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`notify_receiver_id`),
  INDEX `FK1tasngtpnpmxh4yheb91grr5f` (`member_id` ASC) VISIBLE,
  INDEX `FKjh2ij2bpqyty7rw47ed0f4kyu` (`notify_content_id` ASC) VISIBLE,
  CONSTRAINT `FK1tasngtpnpmxh4yheb91grr5f`
    FOREIGN KEY (`member_id`)
    REFERENCES `s09p12d106`.`member` (`member_id`),
  CONSTRAINT `FKjh2ij2bpqyty7rw47ed0f4kyu`
    FOREIGN KEY (`notify_content_id`)
    REFERENCES `s09p12d106`.`notify_content` (`notify_content_id`))
ENGINE = InnoDB
AUTO_INCREMENT = 11
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`small_group` (
  `small_group_id` INT NOT NULL AUTO_INCREMENT,
  `small_group_name` VARCHAR(20) NOT NULL,
  `meeting_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`small_group_id`),
  INDEX `FK9s5nifp0k8afqaktgaihk8a35` (`meeting_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`small_group_member` (
  `small_group_member_id` INT NOT NULL AUTO_INCREMENT,
  `member_id` INT NULL DEFAULT NULL,
  `small_group_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`small_group_member_id`),
  INDEX `FKauygn55gve3ey7kww1mh21m3m` (`member_id` ASC) VISIBLE,
  INDEX `FKn235iv75x7wcqe1hnvpapyryh` (`small_group_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`uncheck_message` (
  `uncheck_message_id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `dm_room_id` VARCHAR(100) NULL DEFAULT NULL,
  `member_id` INT NULL DEFAULT NULL,
  `message_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`uncheck_message_id`),
  INDEX `FK2gjd7p4ak9csb50egqi82ahki` (`dm_room_id` ASC) VISIBLE,
  INDEX `FK6n99f63b0uh85mmfqdet2yrfa` (`member_id` ASC) VISIBLE,
  INDEX `FKqga7bm43x9jhgoy86frgu2v` (`message_id` ASC) VISIBLE,
