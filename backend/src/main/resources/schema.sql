...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`follower` (
  ...
  INDEX `FKb0iqowwac1xx3pwvqu6a5mxrf` (`follower_member` ASC),
  INDEX `FKe6hfwyqbvb5j14hm2eecnqky5` (`member_id` ASC),
  CONSTRAINT `FKb0iqowwac1xx3pwvqu6a5mxrf`
    FOREIGN KEY (`follower_member`)
    REFERENCES `s09p12d106`.`member` (`member_id`),
  CONSTRAINT `FKe6hfwyqbvb5j14hm2eecnqky5`
    FOREIGN KEY (`member_id`)
    REFERENCES `s09p12d106`.`member` (`member_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`notify_content` (
  `notify_content_id` INT(11) NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `notify_body` VARCHAR(100) NOT NULL,
  `notify_header` VARCHAR(45) NOT NULL,
  `member_id` INT(11) NULL DEFAULT NULL,
  `notify_type` ENUM('DM', 'MATCHING', 'MEETING_START') NOT NULL,
  PRIMARY KEY (`notify_content_id`),
  INDEX `FK632twfqwsmij2laxqaawcryuu` (`member_id` ASC),
...
CREATE TABLE IF NOT EXISTS `s09p12d106`.`notify_receiver` (
  `notify_receiver_id` INT(11) NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME(6) NULL DEFAULT NULL,
  `notify_receiver_checked` BIT(1) NOT NULL,
  `member_id` INT(11) NULL DEFAULT NULL,
  `notify_content_id` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`notify_receiver_id`),
  INDEX `FK1tasngtpnpmxh4yheb91grr5f` (`member_id` ASC),
  INDEX `FKjh2ij2bpqyty7rw47ed0f4kyu` (`notify_content_id` ASC),
