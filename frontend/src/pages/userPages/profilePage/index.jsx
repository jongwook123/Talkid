...
export default function ProfilePage() {
  ...
  const isFollowing =
    ...
    followers.some((follower) => follower.followMemberName === user.memberMail);
      ...
      <S.Body>
        ...
        <S.PageBody>
          ...
          <S.LeftBody>
            <h3>왼쪽바디</h3>
            <S.Pic
              src="https://cdn.pixabay.com/photo/2020/04/28/19/36/heart-5106075_960_720.png"
              alt="15616"
            />
            <S.Name>{member.memberName}</S.Name>
            <S.Exptitle>EXP</S.Exptitle>
            <S.ExpBarBackground>
          ...
          <S.RightBody>
            ...
            <S.Title>Nation</S.Title>
            <S.Info>{member.country && member.country.countryName}</S.Info>
            <S.Title>Language</S.Title>
            <S.Info>{member.language && member.language.languageEng}</S.Info>
            {member.memberType && member.memberType.memberTypeId === 1 && (
              <>
                <S.Title>School</S.Title>
                <S.Info>{member.school && member.school.schoolName}</S.Info>
              </>
            )}
            {member.memberType && member.memberType.memberTypeId === 2 && (
              <>
                <S.Title>Introduction</S.Title>
                <S.Info>{member.memberIntroduce}</S.Info>
              </>
            )}
          </S.RightBody>
        </S.PageBody>
