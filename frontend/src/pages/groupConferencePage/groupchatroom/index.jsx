...
export default function GroupChatRoom({
  props: { socketUpdated, socket, user, groupId },
}) {
  ...
  return (
    <S.SectionWrapper>
      <S.SectionRoom>
        ...
        <S.MainRoomWrapper>
          <S.RoomButton onClick={onClickRoomButton}>
            # <span>{groupId}</span>
          </S.RoomButton>
        </S.MainRoomWrapper>
        <S.SubRoomWrapper>
          <S.SubRoomAdd
            onClick={onClickAddSubRoom}
            visible={user.memberType.memberTypeId !== 2}
          >
            <span>+</span>
        ...
        <S.DictionaryWrapper>
          {
            <S.VideoWrapper>
              <Video
                props={{ room: selectedRoom, user, groupId, sendSpeech }}
              />
              <S.ListChat>
