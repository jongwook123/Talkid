...
export const HeaderRooms = styled.header`
    width: 100%;
    height: 48px;
    display: flex;
    align-items: center;
...
export const MainRoomWrapper = styled.div`
    ...
    &::before {
        ...
        margin-bottom: 8px;
        color: ${props => props.theme.colors.font.light_black2};
        font-size: ${props => props.theme.font_size.lv2};
    }
`

export const SubRoomWrapper = styled.div`
    margin-top: 30px;
...
export const SubRoomAdd = styled.button`
